...
function getSelectValueDrink(){
    var selectedValue = (<HTMLInputElement>document.getElementById("myDropdownDrink")).value;
...
function getSelectValueFood(){
    var selectedValue = (<HTMLInputElement>document.getElementById("myDropdownFood")).value;
